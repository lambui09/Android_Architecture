...
import com.lambui09.mvvm.data.common.DataResult.Success
 ...
 */
val DataResult<*>.succeeded get() = this is Success && data != null

val <T> LiveData<DataResult<T?>>.dataOfResult: T? get() = if (value is Success<T?>) (value as Success<T?>).data else null
